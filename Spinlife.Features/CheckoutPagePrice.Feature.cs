...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Validate the cart page functionality")]
        [NUnit.Framework.CategoryAttribute("uiTest")]
        [NUnit.Framework.CategoryAttribute("aniketb")]
        ...
        public virtual void ValidateTheCartPageFunctionality(string productName, string quantity, string expectedPrice, string[] exampleTags)
        {
            ...
            argumentsOfScenario.Add("Quantity", quantity);
            argumentsOfScenario.Add("ExpectedPrice", expectedPrice);
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Validate the cart page functionality", null, tagsOfScenario, argumentsOfScenario);
#line 44
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
...
#line hidden
#line 55
 testRunner.Then(string.Format("I should see the product price as \"{0}\" for \"{1}\"", expectedPrice, quantity), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 56
